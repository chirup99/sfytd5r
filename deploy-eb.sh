...
# AWS Elastic Beanstalk Deployment Script for Perala AI Trading Platform
# This script builds and deploys the application to AWS EB
...
echo "🌐 Your application is available at: http://${CNAME}"
echo ""
